        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className="group flex items-center gap-4 bg-white rounded-2xl p-3 sm:p-4 hover:shadow-md transition-all duration-200 border border-stone-100 text-left w-full cursor-pointer"
            >
              {/* Thumbnail */}
